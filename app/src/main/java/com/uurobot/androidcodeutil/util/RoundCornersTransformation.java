...
import static com.uurobot.androidcodeutil.util.RoundCornersTransformation.CornerType.ALL;

public abstract class RoundCornersTransformation implements Transformation<Bitmap> {
